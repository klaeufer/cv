...
\cvlistitem{\emph{COMP 141: Introduction to Computing Tools and Techniques (Spring 2025)}}

\cvlistitem{\emph{COMP 271: Data Structures I (Spring 2023)}}

\cvlistitem{\emph{COMP 313/413: Intermediate Object-Oriented Development (Fall 2021)}}

\cvlistitem{\emph{COMP 335/488-335: Formal Methods in Software Engineering (Spring 2026)}}

\cvlistitem{\emph{COMP 370/470: Software Quality, Metrics, and Testing (Spring 2023)}}

\cvlistitem{\emph{COMP 371/471: Theory of Programming Languages (Spring 2026)}}

\cvlistitem{\emph{COMP 373/473: Advanced Object-Oriented Programming (Fall 2025)}}
...
\cvlistitem{Beatriz Santos, Advanced Topics in Formal Methods: TLA+ Abstraction and Refinement, 2026--present}

\cvlistitem{Liam Wilson, Investigating Instruction Methods in Open-Source GPUs, 2026}

\cvlistitem{Eric Spencer, TLA-Prover: Verifiable TLA+ Specification Synthesis, 2025--2026}

\cvlistitem{Ryan Hasler, UnoAPI: Modern Parallel C++ Programming with SYCL and oneAPI, 2024}

\cvlistitem{Mshari Ghabban, Test Effectiveness: How Thoroughly are Project Teams Actually Testing?, 2024}

\cvlistitem{Avery Cook, AI-Enabled Curriculum Mapping: Data Structures and Programming Languages Topics, 2023}

\cvlistitem{Stefan Nelson, Automated News Processing: Data Extraction, Topic Identification, and Summarization Using NLP, 2023}

\cvlistitem{Álvaro de Landaluce, Erik Pautsch, and Nick Shannon, SparkBadge: Longitudinal project status badges based on sparklines, \href{https://github.com/klaeufer/sparkbadge}{github.com/klaeufer/sparkbadge}, 2021--2023}

\cvlistitem{Collin Jones, Tools for analyzing cyclomatic code complexity, 2020--2021}

\cvlistitem{Henry Fellerhoff, OpenIPA: Automatic transcription of song lyrics to the international phonetic alphabet, \href{https://github.com/hfellerhoff/openipa}{github.com/hfellerhoff/openipa}, 2020--2021}

\cvlistitem{Jacob Palmer, SparkBadge: Enhanced project status badges based on sparklines, \href{https://github.com/klaeufer/sparkbadge}{github.com/klaeufer/sparkbadge}, 2020--2021}
