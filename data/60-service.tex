...
% Evaluation criteria
% a. Professional: panels, conferences, journals, etc. 
% b. University 
% c. College 
% d. Department 
% e. Community 
...
\cvlistitem{\emph{Technical program committee member}, INSTICC International Conference on Software Engineering and Applications (ICSOFT), 2009--2014, 2017--2018, and 2025--2026}

\cvlistitem{\emph{Technical program committee member}, 12th ACM SIGPLAN Scala Symposium, 2021}

\cvlistitem{\emph{Technical program committee member}, IEEE International Conference on Big Data and Cloud Computing (BDCloud), 2015 and 2018}

\cvlistitem{\emph{Technical program committee member}, INSTICC International Conference on Data Technologies and Applications (DATA), 2012--2014 and 2017--2018}

\cvlistitem{\emph{Technical program committee member}, INSTICC International Joint Conference on Pervasive and Embedded Computing and Communication Systems (PECCS), 2015}

\cvlistitem{\emph{Technical program committee member}, IEEE 1st International Conference on Services Economics (SE 2012)}

\cvlistitem{\emph{Technical program committee member}, IEEE International Conference on Cloud and Green Computing (CGC 2011)}

%\cvlistitem{IARIA International Conference on Cloud Computing (CLOUD 2011)}

\cvlistitem{\emph{Technical program committee member}, Chicago Colloquium on Digital Humanities and Computer Science (DHCS 2011)}

\cvlistitem{\emph{Technical program committee member}, IEEE World Congress on Services (SERVICES), 2010--2011}

\cvlistitem{\emph{Technical program committee member}, International Conference on Software Engineering and Knowledge Engineering (SEKE), 2009--2011)}

\cvlistitem{\emph{Technical program committee member}, IEEE International Conference on Cloud Computing (CLOUD 2010)}

\cvlistitem{\emph{Technical program committee member}, IEEE International Conference on Web Services (ICWS), 2006--2009)}

\cvlistitem{\emph{External reviewer}, 20th International Workshop on Languages and Compilers for Parallel Computing (LCPC), 2007}

\cvlistitem{\emph{Local co-organizer}, North American Computers and Philosophy Conference (NA-CAP), 2006--2007}

\cvlistitem{\emph{Local co-organizer}, Midwest Society for Programming Languages and Systems (MSPLS) Spring 2007 Workshop}

\cvlistitem{\emph{Maintainer} of the permanent general website for the International Conference on Functional Programming (ICFP), 1999--2006}

\cvlistitem{\emph{External reviewer}, ACM Symposium on Principles of Programming Languages (POPL), 2005}

\cvlistitem{\emph{Technical program committee member}, Midwest Software Engineering Conference (MSEC 2004)}

\cvlistitem{\emph{External reviewer}, Symposium on Principles and Practice of Declarative Programming (PPDP), 2000}
...
\cvlistitem{\emph{External reviewer}, International Symposium on Theoretical Aspects of Computer Software (TACS), 1997}

\cvlistitem{\emph{External reviewer}, Symposium on Programming Language Implementation and Logic Programming (PLILP), 1997}
...
\cvlistitem{\emph{External reviewer}, Conference on Functional Programming and Computer Architecture (FPCA), 1993}
...
\cvlistitem{\emph{Book reviewer} for Addison-Wesley, Benjamin-Cummings, Cambridge University Press, Dekker, Macmillan, Prentice-Hall, Scott-Jones, and Wiley, 1992--2010}
...
\cvlistitem{\emph{Computer science program representative}, Academic Council, 2004}
...
\cvlistitem{\emph{Chair}, Non-Tenure-Track Search Committee, 2010--2011 and 2022--2023}

\cvlistitem{\emph{Chair and/or member}, Rank and Tenure Committee, 2005--2012 and 2018--present}
...
\cvlistitem{\emph{Chair}, Undergraduate Curriculum Reform Task Force, 2004}
...
\cvlistitem{\emph{Technical support (pro-bono)}, Malibu Condominium, 1998--2016}
